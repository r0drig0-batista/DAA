...
public class testea {
    ...
    public static void dijkstra(Graph g, int s, int k, int m){

        int[] pai = new int[g.num_vertices() + 1];

        int[] cap = new int[g.num_vertices() + 1];

        for (int i=1; i<g.num_vertices() + 1; i++) {pai[i]=0;cap[i]=0;}
    ...
    public static void main(String[] args){
        ...
        int origem_grupo=stdin.nextInt();
        ...
        for (int i=0;i<n_ligacoes;i++){
            ...
            g.insert_new_edge(origem, destino, lugares);
        }

        dijkstra(g, origem_grupo,min, max);
